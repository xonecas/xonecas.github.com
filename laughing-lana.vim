" laughing-lana.vim - Vim color scheme
" ----------------------------------------------------------
" Author:       @xonecas
" Version:      0.0.1
...
" Declare theme name
let g:colors_name="laughing-lana"
...
let s:darkTeal=        { "gui": "#025D8C" }
let s:middleDarkTeal=  { "gui": "#02779E" }
let s:middleLightTeal= { "gui": "#1693A5" }
let s:lightTeal=       { "gui": "#3BBBB2" }

let s:darkOrange=        { "gui": "#F02311" }
let s:middleDarkOrange=  { "gui": "#FF6600" }
let s:middleLightOrange= { "gui": "#FF9900" }
let s:lightOrange=       { "gui": "#FBB829" }

let s:darkBlue=       { "gui": "#000030" }
let s:middleDarkBlue= { "gui": "#0C0F66" }
let s:middleLightBlue={ "gui": "#67BAF5" }
let s:lightBlue=      { "gui": "#00D2FF" }
...
if &background=="dark"
    ...
    let s:accent1=s:middleLightOrange
    let s:accent2=s:middleLightBlue
    let s:accent3=s:lightBlue
    let s:accent4=s:lightTan
    let s:normRed=s:middleLightTeal
    let s:normBlue=s:middleLightBlue
    let s:normOrange=s:middleLightOrange
    let s:faintRed=s:darkTeal
    let s:faintBlue=s:darkBlue
    let s:faintOrange=s:darkOrange
else
    " Light theme
    let s:bg=s:white
    ...
    let s:accent1=s:middleDarkOrange
    let s:accent2=s:middleDarkBlue
    let s:accent3=s:middleDarkTeal
    let s:accent4=s:darkTan
    let s:normRed=s:middleDarkTeal
    let s:normBlue=s:middleDarkBlue
    let s:normOrange=s:middleDarkOrange
    let s:faintRed=s:lightTeal
    let s:faintBlue=s:lightBlue
    let s:faintOrange=s:lightOrange
endif
...
if version >= 700
    ...
    call s:h("PmenuSel",    { "bg": s:faintOrange })
    ...
    call s:h("SpellRare",   { "sp": s:normBlue, "gui": "undercurl" })
...
call s:h("Visual",       { "bg": s:faintOrange })
call s:h("IncSearch",    { "bg": s:faintOrange })
